        ...
        <el-table-column label="操作" width="180px">
          <template v-slot="slot">
            ...
            <el-tooltip effect="dark" content="分配角色" placement="top" :enterable="false">
              <el-button type="warning" icon="el-icon-setting" circle @click="setRole(slot.row)"></el-button>
            </el-tooltip>
          </template>
        </el-table-column>
      </el-table>
...
export default {
  data() {
    ...
    var checkMobile = (rule, value, callback) => {
      const regEmail = /^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-7|9])|(?:5[0-3|5-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[1|8|9]))\d{8}$/;
      if (regEmail.test(value)) {
        return callback();
      }
